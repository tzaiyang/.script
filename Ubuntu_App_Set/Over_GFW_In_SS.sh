...
sudo echo $(cat ../Surport_Files/supervisord.conf) >> /etc/supervisor/supervisord.conf
...
genpac --proxy="SOCKS5 127.0.0.1:1080" -o ~/.script/Surport_Files/autoproxy.pac --gfwlist-url="https://raw.githubusercontent.com/gfwlist/gfwlist/master/gfwlist.txt"
#设置全局代理
#点击：System settings > Network > Network Proxy ; 
#选择 Method 为 Automatic 
#设置 Configuration URL 为 autoproxy.pac 文件的路径(file:///home/ryan/.script/Surport_Files/autoproxy.pac)
